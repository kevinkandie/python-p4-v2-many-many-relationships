...
# Association table for many-to-many between employees and meetings
...
class Assignment(db.Model):
    ...
    def __repr__(self):
        return (
            f'<Assignment {self.id}, {self.role}, {self.start_date}, '
            f'{self.end_date}, {self.employee.name}, {self.project.title}>'
        )
